    ...
    <div className="fixed inset-0 z-50 overflow-hidden flex items-end md:items-center justify-center md:p-4 transition-all duration-300 pointer-events-auto opacity-100">
      ...
      >
        ...
        <div className="px-5 py-4 border-t border-surface-container-high bg-surface-container-low flex gap-3 flex-shrink-0 rounded-b-2xl">
          <button type="button" id="btn-cancel" onClick={onClose}
    ...
    <div className="flex flex-col min-h-full relative overflow-x-hidden font-sans">
      <div className="bg-primary px-5 md:px-8 pt-8 pb-8 relative overflow-hidden">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3.5 mt-6 relative z-10">
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 text-white">
            ...
            <p className="text-primary-fixed-dim/80 text-xs mt-1">Aturan diskon terdaftar</p>
          </div>
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 text-white">
            ...
            <p className="text-primary-fixed-dim/80 text-xs mt-1">Sedang aktif di kasir</p>
          </div>
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 text-white">
            ...
            <p className="text-primary-fixed-dim/80 text-xs mt-1">Potongan berbasis %</p>
          </div>
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 text-white">
            ...
            <p className="text-primary-fixed-dim/80 text-xs mt-1">Potongan nominal tetap (Rp)</p>
          </div>
        </div>
      </div>
        ...
        {discountsLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {discounts.map((discount) => {
              ...
              return (
                <div key={discount.id} id={`discount-card-${discount.id}`}
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-bold text-on-surface text-base truncate">{discount.name}</h3>
      ...
      {drawerOpen && (
        <DiscountForm
          ...
          onSave={async (data) => {
            if (editingDiscount) {
              await updateDiscount(editingDiscount.id, { ...data, isActive: editingDiscount.isActive });
            } else {
